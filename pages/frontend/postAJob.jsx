            ...
            <div className='w-full  py-20 flex items-center  justify-center flex-col'>
                ...
                <form onSubmit={handleSubmit} className="sm:w-1/2 w-full px-4 mx-4  h-full" >
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, salary: e.target.value })} type="number" id='salary' className='w-full py-2 px-3 mb-2 border border-red-600 rounded' placeholder='Enter Salary for this job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, job_deadline: e.target.value })} type="date" id='jobva' className='w-full py-2 px-3 mb-2 border border-red-600 rounded' placeholder='Enter Deadline of job' />
                        {
